...
<head>
    ...
    <title>Tambah Artikel | PROBISTEK</title>
...
<body>
    ...
    <form method="post" action="" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" id="isi" name="isi" placehoder="Masukkan Isi Artikel" rows="3" required></textarea>
            </div>
        </div>
        <div class="form-group row">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Simpan Artikel?</h5>
                        </div>
